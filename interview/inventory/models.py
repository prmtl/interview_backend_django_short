...
class Inventory(NameModel, TimestampedModel, models.Model):
    type = models.ForeignKey(InventoryType, on_delete=models.CASCADE, related_name="inventories")
    language = models.ForeignKey(InventoryLanguage, on_delete=models.CASCADE, related_name="inventories")
